...
import { getDataForCategoryWomen } from 'src/lib/api'
...
export async function getStaticProps() {
  const allData = (await getDataForCategoryWomen()) ?? []
...
CategoryWomen.displayName = 'CategoryWomen'
export default mark(CategoryWomen)
